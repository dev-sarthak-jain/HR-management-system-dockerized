...
const Dashboard = () => {
  ...
  const employeeData = [
    { id: 1, name: 'Esther Howard', position: "Sale's manager USA", transactions: 3490, rise: true, tasksCompleted: 3, imgId: 0 },
    { id: 2, name: 'Eleanor Pena', position: "Sale's manager Europe", transactions: 590, rise: false, tasksCompleted: 5, imgId: 2 },
    { id: 3, name: 'Robert Fox', position: "Sale's manager Asia", transactions: 2600, rise: true, tasksCompleted: 1, imgId: 3 }
  ];
  ...
  const graphData = [
    ...
    return { name: i, revenue, expectedRevenue, sales: Math.floor(Math.random() * 500) };
  });
        ...
        <div className="flex-grow overflow-x-hidden overflow-y-auto flex flex-col">
          ...
          <div className="w-full p-3 h-28 hidden sm:block sm:h-20 xl:h-32">
            <div
              ...
              style={{ backgroundImage: "url('https://assets.codepen.io/3685267/res-react-dash-usage-card.svg')" }}
            >
  ...
  const NameCard = ({ name, position, transactionAmount, rise, tasksCompleted, imgId }) => {
      ...
      <div className="w-full p-2 lg:w-1/3">
        <div className="rounded-lg bg-card flex justify-between p-3 h-32">
          ...
          <div className="flex flex-col items-center">
            ...
            <animated.div
              className={clsx(rise ? 'text-green-500' : 'text-red-500', 'font-bold', 'text-lg')}
            >
      ...
      <div className="p-4 h-full">
        ...
        {segmentationData.map(({ c1, c2, c3, color }) => (
          <div className="flex items-center" key={c1}>
            ...
            <div className="ml-2" style={{ color }}>{c1}</div>
            <div className="flex-grow" />
            <div className="" style={{ color }}>{c2}</div>
            <div className="ml-2 w-12 card-stack-border" />
            <div className="ml-2 h-8">
              <div className="w-20 h-28 rounded-lg overflow-hidden" style={{ background: c3 }}>
                {c1 === 'Other' && <img src="https://assets.codepen.io/3685267/res-react-dash-user-card.svg" alt="" />}
              </div>
            </div>
          </div>
        ))}
        ...
        <div className="flex justify-center">
          <div className="flex justify-between mt-2" style={{ width: '300px' }}>
            ...
            <div className="" style={{ width: '150px', textAlign: 'center' }}>
              <div className="font-bold" style={{ color: '#2f49d1', fontSize: '18px' }}>97.78%</div>
