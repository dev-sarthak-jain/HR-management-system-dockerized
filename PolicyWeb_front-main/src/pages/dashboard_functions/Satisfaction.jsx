  ...
  return (
    <div className="p-4 h-full">
      <div className="flex justify-between items-center">
        <div className="text-white font-bold">Employee Satisfaction</div>
        <Icon path="res-react-dash-options" className="w-2 h-2" />
      </div>
      <div className="mt-3">From all employees records</div>
      ...
      <div className="flex justify-center">
        <div className="flex justify-between mt-2" style={{ width: '300px' }}>
          ...
          <div className="" style={{ width: '150px', textAlign: 'center' }}>
            ...
            <div className="">Based on AI data analytics</div>
          </div>
