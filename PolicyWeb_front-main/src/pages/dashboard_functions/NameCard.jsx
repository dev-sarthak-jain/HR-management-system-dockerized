...
const NameCard = ({ name, position, transactionAmount, rise, tasksCompleted,message}) => {
      ...
      <div className="rounded-lg bg-card flex justify-between p-3 h-32">
        <div className="">
          <div className="flex items-center">
            <div className="ml-2">
              <div className="flex items-center">
                <div className="mr-4 font-bold text-white">{name}</div>
          ...
          <svg className="w-44 mt-3" height="6" viewBox="0 0 200 6" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <animated.rect width={barPlayhead.interpolate((i) => i * (tasksCompleted / 5) * 200)} height="6" rx="3" fill="url(#paint0_linear)" />
