...
const employeeData = [
  { id: 1, name: 'Tickets raised', position: "Sale's manager USA", transactions: 231, rise: true, tasksCompleted: 3, imgId: 0 },
  { id: 2, name: 'Tickets acknowledged', position: "Sale's manager Europe", transactions: 215, rise: false, tasksCompleted: 5, imgId: 2 },
  { id: 3, name: 'Tickets closed', position: "Sale's manager Asia", transactions: 150, rise: true, tasksCompleted: 1, imgId: 3 },
];
    ...
    <div className="flex w-full">
      ...
      <div className=" h-screen flex-grow overflow-x-hidden overflow-auto flex flex-wrap content-start p-2">
        ...
        {employeeData.map(({ id, name, position, transactions, rise, tasksCompleted, imgId }) => (
          <NameCard key={id} id={id} name={name} position={position} transactionAmount={transactions} rise={rise} tasksCompleted={tasksCompleted} imgId={imgId} />
        ))}
